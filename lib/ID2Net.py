...
class ID2Net(nn.Module):
    ...
    def __init__(self, mode='sgdet',
                 ...
                 enc_layer_num=None, dec_layer_num=None,TopK=8):
        ...
        self.Dtrans = DTrans(obj_classes=obj_classes, topk=self.TopK)
